...
class StarlinkMonitor:
    ...
    def collect_metrics(self) -> Dict[str, Any]:
        ...
        try:
            ...
            ping_servers = (
                ...
                .get("starlink", {})
                .get("servers", DEFAULT_PING_SERVERS)
            )
    ...
    def store_metrics(self, metrics: Dict[str, Any]):
        ...
        try:
            ...
            packet_loss_values = [
                test.get("packet_loss_percent", 0) for test in ping_tests.values()
            ]
            avg_packet_loss = (
                sum(packet_loss_values) / len(packet_loss_values) if packet_loss_values else 0
            )
...
def main() -> int:
    ...
    parser.add_argument(
        "--interval",
        type=int,
        default=DEFAULT_MONITORING_INTERVAL_MIN,
