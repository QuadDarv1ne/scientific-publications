...
import os  # noqa: E402  # импорт после настройки опциональных зависимостей
import sys  # noqa: E402  # импорт после настройки опциональных зависимостей
