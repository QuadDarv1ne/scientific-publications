...
class TestReportGenerator(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.test_config = {"database": {"type": "sqlite"}}
    ...
    def test_init(self):
        ...
        with patch("src.reports.generate_report.create_engine"):
    ...
    def test_generate_daily_report(self):
        ...
        with patch("src.reports.generate_report.create_engine"), patch.object(
            ReportGenerator, "get_metrics_for_period"
        ) as mock_get_metrics:
            # Mock metrics data
            mock_metrics_data = [
                {
    ...
    def test_save_report_as_json(self):
        ...
        with patch("src.reports.generate_report.create_engine"):
            ...
            try:
                report_data = {"test": "data", "metrics": [{"download_mbps": 100.0}]}
