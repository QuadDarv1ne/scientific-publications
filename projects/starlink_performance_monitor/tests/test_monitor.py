...
from src.monitor.monitor import PerformanceMetric, StarlinkMonitor
...
class TestStarlinkMonitor(unittest.TestCase):
    ...
    def test_collect_metrics(self):
        ...
        with patch.object(StarlinkMonitor, "run_speedtest") as mock_speedtest, patch.object(
            StarlinkMonitor, "run_ping_test"
        ) as mock_ping_test:
...
class TestPerformanceMetric(unittest.TestCase):
    ...
    def test_performance_metric_default_values(self):
        ...
        metric = PerformanceMetric(
            download_mbps=100.5, upload_mbps=50.2, ping_ms=25.3, server_name="Test Server"
        )
