# Test Runner Script for Starlink Performance Monitor
...
Write-Host "║  STARLINK MONITOR - TEST RUNNER                  ║" -ForegroundColor Cyan
Write-Host "╚═══════════════════════════════════════════════════╝`n" -ForegroundColor Cyan
...
if ($Coverage) {
    $pytestArgs += "--cov=src", "--cov-report=html", "--cov-report=term-missing"
