...
class TestStarlinkTracker(unittest.TestCase):
    ...
    def test_imports(self):
        ...
        try:
            from core.main import StarlinkTracker  # noqa: F401  # проверка доступности зависимости
            from utils import (
                data_processor,  # noqa: F401  # проверка доступности зависимости
                notify,  # noqa: F401  # проверка доступности зависимости
            )
            from web import web_app  # noqa: F401  # проверка доступности зависимости
...
"""
    ...
    def test_config_loading(self):
        ...
        self.assertEqual(
            tracker.config["data_sources"]["celestrak_url"],
