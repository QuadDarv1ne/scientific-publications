...
class SDOLoader(BaseLoader):
    ...
    def load_aia(self, date: Union[str, datetime], wavelength: int, **kwargs) -> "SolarImage":
        """
        ...
        **kwargs
        ...
        if wavelength not in self.AIA_WAVELENGTHS:
            raise ValueError(
                f"Неподдерживаемая длина волны: {wavelength} Å. "
        ...
        # и ошибка возникала только при попытке загрузить данные SDO.
        try:
