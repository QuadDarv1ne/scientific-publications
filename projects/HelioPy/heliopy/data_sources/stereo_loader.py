    ...
    def load_secchi(
        ...
        **kwargs
        ...
        try:
            ...
            if len(query) == 0:
                raise ValueError(
                    f"Данные не найдены для {date}, космический аппарат {spacecraft}, инструмент {instrument}"
                )
            ...
            raise RuntimeError(f"Ошибка при загрузке данных STEREO/SECCHI: {e}") from e
