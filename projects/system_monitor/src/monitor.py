...
class SystemMonitor:
    ...
    def __init__(
        self, history_size: int = 100, enable_gpu: bool = True, log_file: str | None = None
    ):
...
def console_display(data: dict):
    ...
    print(
        f"║  RAM: [{mem_bar}] {mem_percent:5.1f}%  {mem_used:5.1f}/{mem_total:5.1f} GB".ljust(62)
        + "║"
    )
    ...
    # Top processes
    print("╠══════════════════════════════════════════════════════════╣")
    print("║  TOP PROCESSES (by memory)".ljust(62) + "║")
    print("╠══════════════════════════════════════════════════════════╣")
...
def main():
    ...
    # Создание монитора
    monitor = SystemMonitor(enable_gpu=args.gpu or PYNVML_AVAILABLE, log_file=args.log)
